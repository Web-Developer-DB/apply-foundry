...
for command_name in diagnose neu status checkpoint stammdaten dialog-pruefen dialog-uebernehmen inhalt pruefen layout pdf ats finalisieren tokenbericht tests; do
